# -*- coding: utf-8 -*-
#
# Bitcoin Utilities documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath("../blackcoinutils"))
...
man_pages = [
    (master_doc, "bitcoinutilities", "Bitcoin Utilities Documentation", [author], 1)
]
